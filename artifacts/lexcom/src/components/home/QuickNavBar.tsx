...
const ROW_AI = [
  { emoji: "🖥️", name: "Advokat OS",           href: "/advokat-os" },
...
const ROW_DB = [
  { emoji: "🗄️", name: "Vault Template", href: "/vault" },
  { emoji: "🏢", name: "Legal Ops",       href: "/legal-ops" },
  { emoji: "📄", name: "Studio Opini",    href: "/studio-opini" },
